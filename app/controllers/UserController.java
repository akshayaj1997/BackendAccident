...
public class UserController extends Controller {
    ...
    public Result registerUser() {
        ...
        final String lat = "17.4118461";
        final String long1 = "78.3985267";
    ...
    @Transactional
    public Result activeToPassive(Integer id) {
        if (null == id) {
            return badRequest("Home Id must be provided");
        }


        final User newuser = userDao.passiveUpdate(id);
